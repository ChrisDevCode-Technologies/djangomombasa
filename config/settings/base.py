...
should import from this file and override as needed.
...
# Note: parent.parent.parent because settings is now a package (config/settings/base.py)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.site_metadata',
            ],
        },
    },
]
